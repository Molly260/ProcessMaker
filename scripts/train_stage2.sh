...
LORA_RANK=64
BATCH_SIZE=1
DATA_CONFIG="./dataset/data_config.toml"
OUTPUT_DIR="./output_dir"
OUTNAME="frame9_interpolation"
...
CKPT_PATH="./merged_9frame.safetensors"
...
sample_images_path="./dataset/inter/sample_images.txt"
sample_prompts_path="./dataset/inter/sample_prompts.txt"
dataset_frame_num=9 

accelerate launch --config_file="./config.yaml" \
  --main_process_port=23325 train_stage2.py \
  ...
  --save_every_n_steps=$SAVE_EVERY_N_STEPS --save_precision=bf16 --save_model_as=safetensors \
